...
class Cadastro_cliente : AppCompatActivity() {
    ...
    senha = etsenha?.text.toString()
        ...
        mAuth!!
            .createUserWithEmailAndPassword(email_Cadastro!!,senha!!).addOnCompleteListener(this){ task ->
                mProgress!!.hide()
                if (task.isSuccessful) {
                    ...
                    Toast.makeText(this@Cadastro_cliente, "Authentication failed.",
    ...
    private fun VerifyEmail() {
        ...
        mUser!!.sendEmailVerification()
            .addOnCompleteListener(this) { task ->
                if (task.isSuccessful) {
                    Toast.makeText(this@Cadastro_cliente,
